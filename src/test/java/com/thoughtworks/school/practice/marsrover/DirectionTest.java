...
class DirectionTest {
  ...
  @Test
  void should_turn_to_north_when_esat_turn_left() {
    Direction north = Direction.E.turn(TurnDirection.L);
  ...
  @Test
  void should_turn_to_south_when_east_turn_right() {
    Direction south = Direction.E.turn(TurnDirection.R);

    assertEquals(Direction.S, south);
  }

  @Test
  void should_turn_to_west_when_south_turn_to_right() {
    Direction west = Direction.S.turn(TurnDirection.R);

    assertEquals(Direction.W, west);
  }

  @Test
  void should_turn_to_north_when_west_turn_to_right() {
    Direction north = Direction.W.turn(TurnDirection.R);
